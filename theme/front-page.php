...
<main>
	...
	<div class="row text-center" style="background:#FFF">
		<div class="medium-12 column show-for-medium"><a href="<?php echo get_page_link( '5972' ); ?>"><img style="max-width:none;width:100%"
				 src="<?php echo get_template_directory_uri(), '/assets/img/header--jiko-old.jpg'; ?>" alt="広島最大級！交通事故解決の実績多数！"></a></div>
		<div class="small-12 hide-for-medium"><a href="<?php echo get_page_link( '5972' ); ?>"><img src="<?php echo get_template_directory_uri(), '/assets/img/header--jiko-old-01.jpg'; ?>"
				 alt="広島最大級！交通事故解決の実績多数！"></a></div>
		<div class="small-12 hide-for-medium"><a href="<?php echo get_page_link( '5972' ); ?>"><img src="<?php echo get_template_directory_uri(), '/assets/img/header--jiko-old-02.jpg'; ?>"
				 alt="広島最大級！交通事故解決の実績多数！"></a></div>
	</div>
	...
	<div class="row">
		...
		<div class="column small-12 large-8 contents --mt0 --pt0">
			<section class="contents--section contents--section__flow">
				...
				<div class="row text-center">
					<div class="column small-6">
						...
						<p><a href="<?php echo get_page_link( '5981' ); ?>" class="button hollow"><img src="<?php echo home_url(), '/wp-content/uploads/2018/01/1808468ee5ba7c8e77144ffc03836a8f.png'; ?>"
								 alt="1.事故の発生"></a></p>
					</div>
					<div class="column small-6">
						<h3><a href="<?php echo get_page_link( '5983' ); ?>">2.治療～症状固定</a></h3>
						<p><a href="<?php echo get_page_link( '5983' ); ?>" class="button hollow"><img src="<?php echo home_url(), '/wp-content/uploads/2018/01/567a9153e61bebf4d77c21d23d0bac82.png'; ?>"
								 alt="2.治療～症状固定"></a></p>
					</div>
					<div class="column small-6">
						<h3><a href="<?php echo get_page_link( '5985' ); ?>">3.後遺障害の有無の判定</a></h3>
						<p><a href="<?php echo get_page_link( '5985' ); ?>" class="button hollow"><img src="<?php echo home_url(), '/wp-content/uploads/2018/01/8dedddfbb17930eaedd2595527d6cd72.png'; ?>"
								 alt="3.後遺障害の有無の判定"></a></p>
					</div>
					<div class="column small-6">
						<h3><a href="<?php echo get_page_link( '5987' ); ?>">4.示談交渉<br><span class="--small">※示談不成立の場合裁判</span></a></h3>
						<p><a href="<?php echo get_page_link( '5987' ); ?>" class="button hollow"><img src="<?php echo home_url(), '/wp-content/uploads/2018/01/0cad6f539ace8fa08cdeb0a1a917e621.png'; ?>"
								 alt="4.示談交渉"></a></p>
					</div>
				</div>
			</section>
			...
			<section class="contents--section contents--section__cases">
				...
				<p class="text-center"><img src="<?php echo get_template_directory_uri(), '/assets/img/lp/jiko/cta.png'; ?>" alt="弁護士の介入で慰謝料などが増額するケースが大半です！"
					 class="thumbnail"></p>
				<h3 class="cta--lp_title --contents"><img src="<?php echo get_template_directory_uri(), '/assets/img/lp/jiko/car.png'; ?>"
					 alt="交通事故のアイコン">交通事故に遭ったら<br>弁護士に相談してください！</h3>
			...
			<section class="contents--section contents--section__recommend">
				<article class="post--topic">
					<div class="row align-middle">
						<div class="column small-2 text-center"><a href="<?php echo get_page_link( '5979' ); ?>"><img class="thumbnail"
								 src="<?php echo get_template_directory_uri(), '/assets/img/ImgSDTop1.jpg'; ?>" alt="イメージ画像"></a></div>
				...
				<article class="post--topic">
					<div class="row align-middle">
						<div class="column small-2 text-center"><a href="<?php echo get_page_link( '5972' ); ?>"><img class="thumbnail"
								 src="<?php echo get_template_directory_uri(), '/assets/img/ImgSDTop2.jpg'; ?>" alt="イメージ画像"></a></div>
						<div class="column small-10">
				...
				<article class="post--topic">
					<div class="row align-middle">
						<div class="column small-2 text-center"><a href="<?php echo get_page_link( '6036' ); ?>"><img class="thumbnail"
								 src="<?php echo get_template_directory_uri(), '/assets/img/ImgSDTop3.jpg'; ?>" alt="イメージ画像"></a></div>
						<div class="column small-10">
				...
				<article class="post--topic">
					<div class="row align-middle">
						<div class="column small-2 text-center"><a href="<?php echo get_page_link( '6012' ); ?>"><img class="thumbnail"
								 src="<?php echo get_template_directory_uri(), '/assets/img/ImgSDTop4.jpg'; ?>" alt="イメージ画像"></a></div>
						<div class="column small-10">
				...
				<article class="post--topic">
					<div class="row align-middle">
						<div class="column small-2 text-center"><a href="<?php echo get_page_link( '5994' ); ?>"><img class="thumbnail"
								 src="<?php echo get_template_directory_uri(), '/assets/img/ImgSDTop5.jpg'; ?>" alt="イメージ画像"></a></div>
						<div class="column small-10">
				...
				<article class="post--topic">
					<div class="row align-middle">
						<div class="column small-2 text-center"><a href="<?php echo get_page_link( '6034' ); ?>"><img class="thumbnail"
								 src="<?php echo get_template_directory_uri(), '/assets/img/ImgSDTop6.jpg'; ?>" alt="イメージ画像"></a></div>
						<div class="column small-10">
			...
			<section class="contents--section contents--section__cta text-center"><a href="https://www.law-yamashita.com/contact"><img
					 src="<?php echo get_template_directory_uri(), '/assets/img/ImgTop10.jpg'; ?>" alt="広島の弁護士による交通事故無料相談受付中"></a></section>


			<section class="contents--section">
				<article class="post--topic">
					<div class="row align-middle">
						<div class="column small-4 text-center"><img src="<?php echo get_template_directory_uri(), '/assets/img/ImgCD1.jpg'; ?>"
							 alt="イメージ画像"></div>
				...
				<article class="post--topic">
					<div class="row align-middle">
						<div class="column small-4 text-center"><img src="<?php echo get_template_directory_uri(), '/assets/img/ImgCD2.jpg'; ?>"
							 alt="イメージ画像"></div>
						<div class="column small-8">
				...
				<article class="post--topic">
					<div class="row align-middle">
						<div class="column small-4 text-center"><img src="<?php echo get_template_directory_uri(), '/assets/img/ImgCD3.jpg'; ?>"
							 alt="イメージ画像"></div>
						<div class="column small-8">
				...
				<article class="post--topic">
					<div class="row align-middle">
						<div class="column small-4 text-center"><img src="<?php echo get_template_directory_uri(), '/assets/img/ImgCD4.jpg'; ?>"
							 alt="イメージ画像"></div>
						<div class="column small-8">
			...
			<section class="contents--section contents--section__access">
				<h2 id="front--access">「広島の弁護士による交通事故初回無料相談」サイトについて</h2>
			...
			<div class="contents--section">
				...
				?>
				<dl>
					<dt><span class="label secondary">
							<?php get_the_date( 'Y-m-d' ); ?></span>　
						<?php the_category( '　' ); ?></dt>
				...
				<?php
					endwhile;
				?>
				<p class="text-center contents--section_button" style="margin-top: 2rem"><a href="<?php echo get_page_link( '5749' ); ?>"
					 class="button large">
						<?php NID_SVG::icon( 'list', array() ); ?>お知らせ一覧</a></p>
			</div>
			<?php endif; ?>
...
EOM;
					...
					echo $output;
				?>
				<p class="text-center contents--section_button" style="margin-top: 2rem"><a href="https://www.law-yamashita.com/topics"
					 class="button large" target="_blank">
						<?php NID_SVG::icon( 'list', array() ); ?>メインサイトのお知らせ一覧<br><br><span style="font-size:0.8em">※メインサイトへ移行します。</span></a></p>
			</div>
